...
package net.mcreator.raysmagicmod.world.features.ores;
...
public class UraniumOreFeature extends OreFeature {
	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("raysmagicmod:uranium_ore", FEATURE,
				new OreConfiguration(UraniumOreFeatureRuleTest.INSTANCE, RaysmagicmodModBlocks.URANIUM_ORE.get().defaultBlockState(), 6));
		PLACED_FEATURE = PlacementUtils.register("raysmagicmod:uranium_ore", CONFIGURED_FEATURE,
	...
	private static class UraniumOreFeatureRuleTest extends RuleTest {
		...
		public static void init(FMLCommonSetupEvent event) {
			Registry.register(Registry.RULE_TEST, new ResourceLocation("raysmagicmod:uranium_ore_match"), CUSTOM_MATCH);
		}
